"""
This script is called by the plugin-wrapper, PetriNetClassifier.js, which passes down the
...
from PetriNetClassifier import PetriNetClassifier
...
plugin = PetriNetClassifier(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
